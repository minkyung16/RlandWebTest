                ...
                <section class="menu-card-list">
                    ...
                    <c:forEach var="m" items="${list}">
                        <section class="menu-card">
                            ...
                            <fmt:formatNumber type="number" maxFractionDigits="3" value="${m.price}" var="price"/>
                            <div class="price-block d:flex align-items:flex-end"><span class="font-weight:bold"></span>${price}원<span class="soldout-msg ml:auto mr:auto md:d:none">SOLD OUT</span></div>
                            <div class="img-block">
                                <a href="/menu/detail?id=${m.id}"><img src="/image/menu/8.jpg"></a>
                            </div>
